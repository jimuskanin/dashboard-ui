    ...
    return (
        <div className="relative w-full h-screen">
            ...
            <div className="curtainBody absolute top-0 left-0 w-full h-full">
                {/* Left Curtain */}
                <div id="leftCurtain" className="curtainContainer transform -translate-x-[5vw]">
                ...
                {/* Right Curtain */}
                <div id="rightCurtain" className="curtainContainer transform translate-x-[15vw]">
                    {Array.from({ length: 12 }).map((_, index) => (
                        <div key={index} className="unCurtain" style={{ animationDelay: `-${index * 0.1}s` }}></div>
                    ))}
                </div>
                ...
                {/* Overlay */}
                <div className="overlay absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black via-transparent to-black opacity-100 transition-opacity duration-300"></div>
            </div>
