...
function Cartier() {
    ...
    useEffect(() => {
        ...
        // console.log('Trigger Element:', contentAboveRef.current);
        ...
        gsap.timeline({
            ...
            .to(rightCurtainRef.current, { x: "100%", duration: 3, ease: "power2.out" }, "<")
            .to(contentAboveRef.current, { opacity: 0, duration: 3 }, "<");
    ...
    return (
        <div>
            ...
            <div className="relative w-[100vw] h-[100vh] overflow-hidden">
                ...
                <div
                    ref={contentAboveRef}
                    className="content-above fixed top-0 left-0 w-full h-full"
                    style={{
                        zIndex: 100,
                    }}
                >
                ...
                <div
                    ref={contentBelowRef}
                    className="content absolute top-0 left-0 w-full h-full"
                >
                    <img
