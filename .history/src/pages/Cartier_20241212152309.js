...
function Cartier() {
    ...
    useEffect(() => {
        ...
        thirdTimeline.to("body::before", { opacity: 0, duration: 2 }, 0);
        thirdTimeline.to(thirdBackgroundRef.current, { opacity: 1, duration: 2 }, 0);
        thirdTimeline.to(brandLogoRef.current, { opacity: 0, duration: 2 }, 0);
        timeline.to(oLogoRef.current, {
            top: "0%",
            left: "50%",
