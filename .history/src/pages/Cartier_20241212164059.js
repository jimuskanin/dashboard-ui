...
import pattern from "../assets/images/cartier/logo/parts/pattern.png";
...
function Cartier() {
    ...
    useEffect(() => {
        ...
        // thirdTimeline.to(thirdSectionRef.current, { opacity: 1, duration: 3 });
        // thirdTimeline.to("body::before", { opacity: 0, duration: 3 }, 0);
        // thirdTimeline.to(thirdBackgroundRef.current, { opacity: 1, duration: 3 }, "<");
        thirdTimeline.to(brandLogoRef.current, { opacity: 0, duration: 2 });
        thirdTimeline.to(oLogoRef.current, { opacity: 0, duration: 2 }, "<");
        // thirdTimeline.fromTo(oLogoRef.current,
        //     {
        //         top: "0%",
        //         left: "50%",
        //         transform: "translate(30%, 180%)",
    ...
    return (
        <div className="relative w-[100vw] h-full">
            ...
            <div
                ref={thirdSectionRef}
                className="relative w-full h-[200vh] flex flex-col items-center justify-center"
                style={{
