...
import pattern from "../assets/images/cartier/logo/parts/pattern-green.png";
...
function Cartier() {
    ...
    useEffect(() => {
        ...
        secondTimeline.to(brandLogoRef.current, { opacity: 0, duration: 1, ease: "power2.inout" });
        secondTimeline.to(oLogoRef.current, { opacity: 0, duration: 1, ease: "power2.in" }, "<");
    ...
    return (
        <div className="relative w-[100vw] h-full">
            ...
            >
                {/* <div className="absolute top-[50%] left-[50%] bottom-0 translate-x-0"> */}
                    <img
                        src={pattern}
                        alt="Tree"
                        className="w-[200px] h-auto object-contain w-[200px] h-auto object-contain absolute left-[0%] bottom-0 translate-x-0"
                    />
                {/* </div> */}
            </div>
