        ...
        <div className="relative w-[100vw] h-full">
            ...
            >
                <img
                    ...
                    src={pattern1}
                    alt="DoDeal"
                    className="animate-circular-motion w-[200px] h-auto object-contain w-[200px] h-auto object-contain absolute left-[10vw] bottom-0"
                />
                <img
                    ref={pattern2Ref}
                    src={pattern2}
                    alt="DoDeal"
                    className="animate-circular-motion w-[200px] h-auto object-contain w-[200px] h-auto object-contain absolute right-[10vw] bottom-[20vh]"
                />
            </div>
