        ...
        <div className="relative w-[100vw] h-full">
            ...
            >
                <img
                    src={pattern1}
                    alt="DoDeal"
                    className="animate-rotate w-[200px] h-auto object-contain w-[200px] h-auto object-contain absolute left-[10vw] bottom-[10vh]"
                />
                <img
                    src={pattern2}
                    alt="DoDeal"
                    className="animate-rotate w-[200px] h-auto object-contain w-[200px] h-auto object-contain absolute right-[10vw] top-[10vh]"
                />
            </div>
