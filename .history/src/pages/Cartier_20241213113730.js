...
function Cartier() {
    ...
    useEffect(() => {
        ...
        firstTimeline.to(leftCurtainRef.current, { x: "-100%", duration: 3, ease: "power2.out" });
        firstTimeline.to(rightCurtainRef.current, { x: "100%", duration: 3, ease: "power2.out" }, "<");
        firstTimeline.to(contentAboveRef.current, { opacity: 0, duration: 3, ease: "power2.out" }, "<");
        firstTimeline.to(brandLogoRef.current, {
            opacity: 1,
            scale: 1,
            duration: 3,
            transform: "translate(-50%, -50%)"
        }, "<");
        firstTimeline.to(oLogoRef.current, {
            opacity: 1,
            scale: 1,
            transform: "translate(30%, -150%)",
            duration: 3,
        ...
        thirdTimeline.to(brandLogoRef.current, {
            opacity: 1,
            transform: "translate(-50%, -50%)",
            duration: 3,
        });
        thirdTimeline.to(oLogoRef.current, {
            opacity: 1,
            transform: "translate(30%, -150%)",
            duration: 3,
        }, "<");
        thirdTimeline.to(mottoRef.current, {
            opacity: 0,
        }, "<");
        secondTimeline.to(mottoRef.current,
            {
                opacity: 0,
                scale: 1,
            },
        ...
        <div className="relative w-[100vw] h-full">
            ...
            >
                <img
                    src={pattern1}
                    alt="DoDeal"
                    className="animate-rotate w-[200px] h-auto object-contain w-[200px] h-auto object-contain absolute left-[5vw] bottom-[5vh]"
                />
                <img
                    src={pattern2}
                    alt="DoDeal"
                    className="animate-rotate w-[200px] h-auto object-contain w-[200px] h-auto object-contain absolute right-[5vw] top-[5vh]"
                />
            </div>
